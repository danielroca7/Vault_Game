...
namespace Assets.Code.States
{
	public class StateNewRegister : InterfacesStados
	{
		...
		public void ShowIt ()
		{
			...
			mail = GUI.TextField (new Rect (Screen.width * 0.1f, Screen.height * 0.86f, Screen.width * 0.60f, 20.0f), mail, 25);

			if(GUI.Button(new Rect(Screen.width * 0.50f, Screen.height * 0.93f, 80.0f, 20.0f), new GUIContent("Registrar", "Tiene que completar todos los campos")))
			{
